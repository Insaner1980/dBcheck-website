...
const en = {
  ...
  footerTagline: 'A quiet instrument for a loud world.\nSound level meter & hearing health companion for Android.', footerExplore: 'Explore', comingSoon: 'Coming soon to Google Play', listen: 'Listen to the page', disclaimer: 'dBcheck supports education, awareness and personal relative tracking.\nIt is not a certified sound level meter or a clinical diagnostic tool.',

...
const en = {
  skip: 'Skip to content', mainNav: 'Main', menu: 'Explore', tools: 'Tools', pricing: 'Pricing', articles: 'Articles', sounds: 'Sound Library', contact: 'Contact', search: 'Search', closeSearch: 'Close search',
  ...
  footerTagline: 'A quiet instrument for a loud world.\nSound awareness and personal hearing-result tracking for Android.', footerExplore: 'Explore', footerFinnvek: 'Finnvek', aboutMaker: 'About the maker', otherApps: 'Other apps', disclaimer: 'dBcheck supports education, awareness and personal relative tracking.\nIt is not a certified sound level meter or a clinical diagnostic tool.',
...
const de = {
  ...
  footerTagline: 'Ein ruhiges Instrument für eine laute Welt.\nSchallbewusstsein und verständliche Rechner für Android.', footerExplore: 'Entdecken', footerFinnvek: 'Finnvek', aboutMaker: 'Über die Entwicklerin', otherApps: 'Weitere Apps', disclaimer: 'dBcheck unterstützt Bildung, Aufmerksamkeit und persönliche relative Verlaufskontrolle.\nEs ist weder ein zertifizierter Schallpegelmesser noch ein klinisches Diagnoseinstrument.',

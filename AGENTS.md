...
- `src/pages/search.json.js` kokoaa haun julkaistuista article- ja sound-kokoelmista sekä muista julkisista sivuista. `@astrojs/sitemap` muodostaa sitemapin vain kanonisista julkisista reiteistä.
